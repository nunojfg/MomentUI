#import "IFZenFilter.h"

NSString *const kIFZenShaderString = SHADER_STRING
(
...
@implementation IFZenFilter


- (id)init
{
    self = [super   initWithFragmentShaderFromString:kIFZenShaderString
                                             sources:@[
                                                       [IFImageFilter filterImageNamed:@"zenMetal"],
                                                       [IFImageFilter filterImageNamed:@"zenSoftLight"],
                                                       [IFImageFilter filterImageNamed:@"zenCurves"],
                                                       [IFImageFilter filterImageNamed:@"zenOverlayMapWarm"],
                                                       [IFImageFilter filterImageNamed:@"zenColorShift"],
                                                       ]];
    return self;
}
@end
